We need the base chrome components that frame every editor screen - the top navbar and the left sidebar shell. These will be reused extended in every chapter that follows.
...
- no lint errors- dialog pattern is ready for future use
