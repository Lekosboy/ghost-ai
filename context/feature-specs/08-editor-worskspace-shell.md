Build the `/editor/[roomId]` worskpace shell with server-side access checks. No canvas logic yet.
...
- users withouts project access see `AccessDenied`
...
- access helper exists outside the page componente
